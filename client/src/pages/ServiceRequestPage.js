    ...
    return (
        <Container>
            ...
            {success && <Message positive>
                ...
                <Message.Content>
                   <p>Our Experts will look into the problems and will contact you soon.
                    We will notify you about the price for the service.
                    please check your profile page to make payment of your service request.
                    our service expert will be there shortly.</p> 
                </Message.Content>
            </Message>}
